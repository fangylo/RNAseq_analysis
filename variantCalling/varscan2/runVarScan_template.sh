...
#$-l mf=8G
#$-pe smp 2
#$-o TOBEREPLACEDTO_PROJECTDIRECTORY/varscan2/log/XXXXX.log
#$ -N varscan2

echo "username="$USER
echo "hostname="`hostname`

referenceFasta=TOBEREPLACEDTO_REFFASTAFILE
# /dev/shm/genomes/hg19/fasta/genome.fa

sample=XXXXX
echo "sample="$sample

cd TOBEREPLACEDTO_PROJECTDIRECTORY
cd $sample
